...
\caption{La boucle \mintinline{swift}{for … in} appliquée au chaînes de caractères.}
\end{listing}
La variable car est du type \mintinline{swift}{Char}.
Il est possible de la convertir en chaîne de caractères en utilisant la syntaxe \mintinline{swift}{String(car)}
