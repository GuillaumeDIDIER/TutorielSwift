...
Pour exécuter \mintinline{swift}{println("b est nul ! Division impossible.")}, nous allons utiliser notre première instruction composée : \mintinline{swift}{if}, \og si \fg{}.
...
mais il existe une solution plus claire : \mintinline{swift}{else}, \og sinon \fg{}.
\begin{listing}[h]
\begin{minted}[linenos]{swift}
let b = 0
if b == 0 {
...
Il est enfin possible de traiter des cas plus complexe avec \mintinline{swift}{else if}, \og sinon si \fg{}.
