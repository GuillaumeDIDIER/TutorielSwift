...
Pour exécuter \mintinline{swift}{print("b est nul ! Division impossible.")}, nous allons utiliser notre première instruction composée : \mintinline{swift}{if}, \og si \fg{}.
